...
5. Treat relative local notes, raw source files, local schedule records, and source paths as deliverables by default. Do not invent external ids/URLs, synchronization results, code changes, or a raw transcript that was not supplied.
